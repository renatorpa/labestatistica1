...
\textbf{3.} Gere a distribuição geométrica para diferentes valores de p : \$ = 0.1\$, \(p = 0.5\), e \(p = 0.9\).
...
\includegraphics{introR_files/figure-latex/unnamed-chunk-264-2.pdf}
...
\section{Exercícios}\label{exercuxedcios-26}
...
\includegraphics{introR_files/figure-latex/unnamed-chunk-285-1.pdf}
...
\section{Exercícios}\label{exercuxedcios-27}
...
\includegraphics{introR_files/figure-latex/unnamed-chunk-300-2.pdf}
...
\includegraphics{introR_files/figure-latex/unnamed-chunk-305-2.pdf}
...
\section{Exercícios}\label{exercuxedcios-30}
