...
\item
  Plote um gráfico de barras para visualizar a distribuição de probabilidades.
\item
...
\tightlist
\item
  Usando R e fixando a semente em 123, gere uma amostra aleatória de 10.000 observações de \(X\).
\item
