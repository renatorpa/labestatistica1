...
\textbf{1.} Em uma determinada localidade a distribuição de renda, em u.m. (unidade monetária) é uma variável aleatória \(X\) com função de distribuição de probabilidade:
...
\textbf{2.} Sabe-se que uma variável aleatória contínua \(X\) é distribuída uniformemente no intervalo 10 e 20.
...
\textbf{3.} O tempo de espera (em minutos) para ser atendido em um posto de atendimento ao cliente é uma variável aleatória contínua \(Y\) , cuja função de densidade de probabilidade é dada por:

\[
f(y) = 
\begin{cases} 
0.5y, & 0\leq y\leq 4 \\[10pt]
...
\textbf{4.} A duração, em anos, de uma certa lâmpada especial é uma variável aleatória contínua com densidade dada por:
...
## 4 1000        0.494 0.494 0.2502142      0.006 0.0002142142
\end{verbatim}
...
\includegraphics{introR_files/figure-latex/unnamed-chunk-249-2.pdf}
...
\includegraphics{introR_files/figure-latex/unnamed-chunk-254-2.pdf}
...
\includegraphics{introR_files/figure-latex/unnamed-chunk-266-1.pdf}
...
\includegraphics{introR_files/figure-latex/unnamed-chunk-267-1.pdf}
...
\includegraphics{introR_files/figure-latex/unnamed-chunk-295-1.pdf}
...
\includegraphics{introR_files/figure-latex/unnamed-chunk-296-1.pdf}
...
\includegraphics{introR_files/figure-latex/unnamed-chunk-298-1.pdf}
...
\includegraphics{introR_files/figure-latex/unnamed-chunk-299-2.pdf}
...
\includegraphics{introR_files/figure-latex/unnamed-chunk-304-2.pdf}
...
\includegraphics{introR_files/figure-latex/unnamed-chunk-305-1.pdf}
...
\includegraphics{introR_files/figure-latex/unnamed-chunk-306-1.pdf}
...
\includegraphics{introR_files/figure-latex/unnamed-chunk-307-1.pdf}
...
\section{Exercícios}\label{exercuxedcios-25}
