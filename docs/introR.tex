...
\item
  Utilize um loop \texttt{for} e a estrutura \texttt{if-else} para classificar os funcionários como ``Atingiu Meta'' ou ``Não Atingiu Meta'', criando um vetor de saída com esses resultados.
\end{itemize}
...
\includegraphics{introR_files/figure-latex/unnamed-chunk-243-2.pdf}
