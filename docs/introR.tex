...
\textbf{6.} Transforme a coluna \texttt{am} do data frame \texttt{mtcars} num fator com
...
\textbf{7.} Utilizando o data frame \texttt{mtcars}, aplique a função \texttt{sapply()}
...
\textbf{9.} Crie dois data frames, \texttt{carros1} e \texttt{carros2}, que contenham
diferentes subconjuntos de informações do data frame \texttt{mtcars}. Depois,
use a função \texttt{merge()} para combinar esses data frames com base na
coluna \texttt{car}.
