...
\textbf{12.} Crie um array tridimensional de dimensão 3x3x3 com valores de 1 a 27. Em seguida:
...
\textbf{13.} Crie um array 3x3x3 com números inteiros de 1 a 27. Acesse os seguintes elementos e fatias do array:

\begin{itemize}
\tightlist
\item
  O elemento na posição (2, 3, 1).
\item
  Todos os elementos da terceira linha da segunda camada.
\item
  A segunda camada inteira.
\end{itemize}

\textbf{14.} Crie dois arrays tridimensionais 2x2x2 com valores aleatórios entre 1 e 10. Realize as seguintes operações:
...
\textbf{4.} \textbf{Exercício 4:} Escreva um programa em R que leia a idade de uma pessoa e a classifique como ``Criança'' (0-12 anos), ``Adolescente'' (13-17 anos), ``Adulto'' (18-64 anos), ou ``Idoso'' (65 anos ou mais). Se a idade inserida for negativa, o programa deve exibir ``Idade inválida''.
...
\includegraphics{introR_files/figure-latex/unnamed-chunk-238-2.pdf}
