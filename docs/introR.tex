...
permite que o \textbf{código seja lido de maneira sequencial, de cima para
...
\textbf{7.} Dado o dataset \texttt{mtcar}s, crie uma nova coluna chamada \texttt{hp\_per\_wt} que seja a razão entre \texttt{hp} e \texttt{wt}. Em seguida, filtre os carros com essa razão maior que 30, e selecione as colunas \texttt{mpg}, \texttt{hp\_per\_wt}, e \texttt{gear}.
...
\includegraphics{introR_files/figure-latex/unnamed-chunk-244-2.pdf}
