...
\includegraphics{introR_files/figure-latex/unnamed-chunk-248-2.pdf}
...
Seja \(X\) uma variável aleatória com distribuição binomial, com \(n=10\) e \(p=0.35\). Vamos ver os comandos do R para:

\begin{itemize}
\item
  Fazer o gráfico da função de probabilidade.
\item
  Fazer o gráfico da função de distribuição acumulada.
\item
  Calcular \(P(X=7)\).
\item
  Calcular \(P(X \leq 7)\).
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Função de probabilidade e fx e função de distribuição Fx}
...
\DocumentationTok{\#\# [1] 0.02120302}
\CommentTok{\# P(X \textless{}= 7)}
...
\DocumentationTok{\#\# [1] 0.004821265}
...
\DocumentationTok{\#\# [1] 0.004821265}
\CommentTok{\# P(3 \textless{} X \textless{}= 6)}
...
\textbf{Definição}: A variável aleatória discreta \(X = \text{"número de ocorrências de um acontecimento por unidade de tempo ou de espaço (comprimento, área, volume, etc.)"}\)
...
\section{Cálculo de probabilidades}\label{cuxe1lculo-de-probabilidades-2}
...
\begin{verbatim}
##  [1] -0.60189285 -0.99369859  1.02678506  0.75106130 -1.50916654 -0.09514745
##  [7] -0.89594782 -2.07075107  0.15012013 -0.07921171
\end{verbatim}
...
\section{Função de distribuição empírica}\label{funuxe7uxe3o-de-distribuiuxe7uxe3o-empuxedrica-1}
...
\includegraphics{introR_files/figure-latex/unnamed-chunk-282-2.pdf}
...
\includegraphics{introR_files/figure-latex/unnamed-chunk-287-2.pdf}
